...
**You sold $truncate[$multi[$message[2];1]] <:sulphur:915398728477716503> and earned $truncate[$multi[20;$message[2]]]$getVar[symbol]**

$setGlobalUserVar[cash;$sum[$getGlobalUserVar[cash];$truncate[$multi[20;$message[2]]]]]
